...
import type { ScheduleResponseDto } from "../api/schedules.api";
import { useDeleteSchedule } from "../hooks/use-schedules";

export function DeleteScheduleButton({ schedule }: { schedule: ScheduleResponseDto }) {
  const t = useTranslations("reports.schedules.deleteDialog");
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>{t("description", { reportCode: schedule.reportCode })}</DialogDescription>
        </DialogHeader>
